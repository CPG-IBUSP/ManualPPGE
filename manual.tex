...
Nossa filosofia é dar ao aluno liberdade para buscar as disciplinas
...
Cabe ao seu/sua orientador(a) e a você compor um plano de estudo com
...
\textbf{obrigatória} \textbf{para as alunas e alunos de doutorado} e
...
\item Coleta de informações adicionais não previstas no cronograma
  original;
\item Análises adicionais não p revistas no cronograma original;
...
bolsa é transferida para o próximo classificado, mesmo que o antigo
bolsista ainda não tenha concluído sua pós-graduação.
...
formulário entregue para a Comissão PROEX, portanto, esteja atento aos
...
reembolso), a Comissão PROEX prepara um resumo das regras dando ênfase
...
de comunicação entre os alunos e os docentes do Programa.

Para conhecer mais visite \url{http://ecoencontros.ib.usp.br}.
Estaj também atento(a) a cartazes nos murais do prédio no qual o
...
Universidade de São Paulo e organizado pelo corpo discente do
Programa, sob a supervisão da Profª. Daniela Scarpa. O curso busca:
...
Para conhecer mais e participar visite \url{http://143.107.244.86/ecologia/ecoescola}.
...
\item[perseguição (“stalking”):] importunação, perseguição obsessiva e
...
jornada. Todo pesquisador tem liberdade para gerir seu horário, pois
há certas metas que exigem períodos de jornadas longas e não usuais,
como a coleta de dados, uma disciplina intensiva, ou finalizar o texto
da qualificação. Há um risco grande de confundir esta liberdade de
gestão do horário e a sucessão de rotinas diferentes com falta de
rotina. Por isso, capacidade de planejamento é tão vital para o
pesquisador como suas ideias, seu conhecimento ou sua capacidade de
trabalho.
